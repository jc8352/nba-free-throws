...
with open('2022_players_shooting.json') as file1:
	data = json.loads(file1.read())

with open('2022_players_traditional.json') as file3:
	data2 = json.loads(file3.read())

with open('2022_players_drives.json') as file4:
	data3 = json.loads(file4.read())

with open('2022_players_cs.json') as file5:
...
with open('2022_players_complete.csv', 'w') as file2:
